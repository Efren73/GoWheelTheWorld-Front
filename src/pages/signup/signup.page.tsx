...
import ImagenPrincipal from '../login/ImagenPrincipal.png';
            ...
            <VStack w="full" spacing={8}>
              ...
              <VStack w="full" spacing={4}>
                ...
                <FormControl w="62%">
                  ...
                  <Input placeholder="What's your email address?" borderRadius={10} fontSize="20px" size='lg'/>
                </FormControl>
                <FormControl w="62%">
              ...
              <Button size='lg'
                      width='62%'
                      fontSize='25px'> Create Account </Button>
            </VStack>
          </Box>
        </Flex>
      </Container>
